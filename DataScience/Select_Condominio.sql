SELECT bloco_nro,apartamento_nro,nome_texto,sobrenome_texto,sexo_texto,idade_valor,modelo_texto,marca_texto,ano_valor,animais_texto,empresa_texto,profissao_texto,salario_valor,filhos_valor,garagem_valor,gravacao_data FROM Condominvs..condominio AS A
